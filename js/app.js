...
function getDataFromLocalStorage() {
  ...
  if (tmpData) {
    ...
    return {
      '0': [
        {text: 'Создавайте карточки'},
        {text: 'Меняте карточки местами'},
        {text: 'Переносите карточки в другие столбцы'},
        {text: 'Редактируйте карточку, дважды кликнув по ней'},
      ],
      '1': [
        {text: 'Чтобы зарешить редактирование, нажмите Ctrl+Enter (или просто кликните вне карточки'},
        {text: 'Чтобы удалить карточку, перетащите её за пределы колонок'},
        {text: 'Смело перезагружайте страницу, данные сохранятся в браузере'}
      ],
      '2': [
      ]
    };
